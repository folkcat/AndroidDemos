package com.folkcat.demo.fingerprint;
...
/**
 * Created by Tamas on 2016/10/13.
 */
...
public class FingerPrintActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check = (Button) findViewById(R.id.btn_check_finger_print);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_check_finger_print:
                /**
